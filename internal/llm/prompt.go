...
### СКОЛЬКО ТЕСТОВ СОЗДАВАТЬ:
- 1 тест для простых случаев (IDOR с числовым ID: просто подставить другое число)
- 2-5 тестов для сложных (MongoDB ID + NoSQLi: разные операторы: $ne, $regex, разные ID)
- Модель сама решает сколько нужно на основе сложности находки
