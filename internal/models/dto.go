...
type HypothesisData struct {
	InvestigationSuggestions []InvestigationSuggestion `json:"investigation_suggestions,omitempty"`
	SiteUnderstanding        SiteUnderstanding         `json:"site_understanding,omitempty"`
